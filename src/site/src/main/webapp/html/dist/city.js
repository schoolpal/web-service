	...
	$.fn.citys = function (parameter, getApi) {
	    ...
	    return this.each(function () {
	        ...
	        _api.getInfo = function () {
	            var status = {
	                direct: !hasCity,
	                province: cityData[options.province] || '',
	                city: cityData[options.city] || '',
	                area: cityData[options.area] || '',
