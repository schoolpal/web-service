...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <ol class="breadcrumb col-xs-6">
                    ...
                    <li class="active"><strong>编辑组织</strong></li>
                </ol>
                <div class="col-xs-6">
                    <div class="btn-toolbar pull-right" role="toolbar">
                        <button class="btn btn-default" data-type="CommandButton" id="mod" data-action="<c:url value='/config/org/edit/save.html'/>">
    ...
    <section>
        <ul>
            ...
            <li>
                ...
                <input id="parent" type="text" data-id="${form.parentId}" value="${form.parentCnFullName}" disabled />
    ...
    <script type="text/javascript">
        var orgId = '${form.id}';
        var provinceVal = '${form.province}';
        var cityVal = '${form.city}';
        var countyVal = '${form.county}';
    </script>
    
    <%@ include file="../../_bottom.jsp"%>
    <script type="text/javascript" src="<c:url value='/js/config/org/china.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/js/config/org/edit.js'/>"></script>
</body>
</html>