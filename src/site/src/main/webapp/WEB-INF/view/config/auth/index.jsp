...
<head>
    <jsp:include page="../../_head.jsp">
        <jsp:param name="subTitle" value="权限管理" />
    </jsp:include>
    <link rel="stylesheet" type="text/css" href="<c:url value='/css/config/auth/index.css'/>" />
</head>
<body>
    <header>
    ...
    <section class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-2" id="roles">
            </div>
            <div class="col-xs-7" id="selections">
            </div>
        </div>
    </section>

    <%@ include file="../../_bottom.jsp"%>
    <script type="text/javascript" src="<c:url value='/js/config/auth/index.js'/>"></script>
</body>
</html>