...
public class ConfigService {
	...
	public boolean addOrg(OrgForm form, String creator) {
		...
		return configDB.addOrg(form.getOrgCode(), form.getCnFullName(), "", "", "", form.getProvince(), form.getCity(), form.getCounty(), 
				form.getAddress(), form.getOwner(), form.getPhone(), form.getParentId(), parentIdMap.get("parent_id"), parentIdMap.get("root_id"), creator);
	}
	
	public boolean updateOrg(OrgForm form, String modifier) {
		String orgRootId = configDB.getOrgRootId(form.getParentId());
		return configDB.updateOrg(form.getId(), form.getOrgCode(), form.getCnFullName(), "", "", "", form.getProvince(), form.getCity(),
				 form.getCounty(), form.getAddress(), form.getOwner(), form.getPhone(), form.getParentId(), orgRootId, modifier);
	}
	...
	public void addUser(String creatorId, UserForm form) {
		...
		String userId = configDB.addUser(form.getUsername(), form.getPasswd(), form.getNameCN(), form.getNameEN(), 
				form.getPhone(), form.getEmail(), form.getIm(), form.getOrgId(), rootOrgId, creatorId);
	...
	public void modUser(String creatorId, UserForm form) {
		configDB.modUser(form.getUserId(), form.getUsername(), form.getPasswd(), form.getNameCN(), form.getNameEN(), 
